...
parser.add_argument('--dataset', '-d', type=str, default='stl10', choices=['cifar10', 'stl10'],
                    help='Choose between CIFAR-10, STL-10.')
...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./snapshots/baseline_stl10', help='Folder to save checkpoints.')
...
data_path = Path('../data/stl10').resolve()
